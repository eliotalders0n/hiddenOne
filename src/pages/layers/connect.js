...
function Connect(props) {
  return (
    <Row
      xs={1}
      md={5}
      className="g-4 animate__animated animate__fadeIn animate__slow animate__delay-1s"
    >
      <Col>
        <a
        ...
        >
          ...
          >
            ...
            >
              ...
              <Card.Text>
                <p className="lead">Fork Pull Watch. @eliotalders0n.</p>
              </Card.Text>
            </Card.Body>
          </Card>
        </a>
      ...
      <Col>
        <a
          href="https://www.facebook.com/root.dedsec.98"
          style={{ textDecoration: "none" }}
        >
          <Card
            style={{
          ...
          >
            ...
            >
              <Card.Title>
                <h5 className="display-5">Facebook</h5>
              </Card.Title>
              <Card.Text>
                <p className="lead">@RootDedsec. Feel free to text me.</p>
              </Card.Text>
            </Card.Body>
          </Card>
        </a>
      ...
      <Col>
        <a
          href="https://twitter.com/RecordCtrl"
          style={{ textDecoration: "none" }}
        >
          <Card
            style={{
          ...
          >
            ...
            >
              <Card.Title>
                <h5 className="display-5">Twitter</h5>
              </Card.Title>
              <Card.Text>
                <p className="lead">@RecordCtrl. Follow me.</p>
              </Card.Text>
            </Card.Body>
          </Card>
        </a>
      ...
      <Col>
        <a href="https://wa.link/hahp2t" style={{ textDecoration: "none" }}>
          ...
          >
            ...
            >
              <Card.Title>
                <h5 className="display-5">Whatsapp</h5>
              </Card.Title>
              <Card.Text>
                <p className="lead">Text / Call +260 974 755 027</p>
              </Card.Text>
            </Card.Body>
          </Card>
        </a>
      ...
      <Col>
        <a
          href="https://instagram.com/pukuta_mwanza?igshid=OGQ5ZDc2ODk2ZA=="
          style={{ textDecoration: "none" }}
        >
          <Card
            style={{
          ...
          >
            ...
            >
              <Card.Title>
                <h5 className="display-5">Instagram</h5>
              </Card.Title>
              <Card.Text>
                <p className="lead">pukuta_mwanza</p>
              </Card.Text>
            </Card.Body>
          </Card>
        </a>
