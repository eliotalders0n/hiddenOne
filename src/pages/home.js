  ...
  return (
    ...
    >
      ...
      <svg
        ...
        alt="Pukuta Mwanza"
        viewBox="0 0 800 400" // Update with the original width and height of the SVG
        style={{ width: "90%", height: "auto", marginLeft: "10%" }} // Add this line for responsiveness
      >
        <path
      ...
      <Container fluid>
        <Col className="my-2 animate__animated animate__fadeIn animate__slow animate__delay-1s text-center">
